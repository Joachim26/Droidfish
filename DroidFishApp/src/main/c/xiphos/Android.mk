...
ENGINE := Xiphos
SF_SRC_FILES := \
bitboard.c gen.c history.c make.c move_list.c perft.c position.c tablebases.c uci.c \
eval.c hash.c main.c move_eval.c pawn_eval.c phash.c search.c tables.c util.c \
fathom/tbprobe.c
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
  ...
  LOCAL_MODULE    := xiphos_nosimd
  include $(LOCAL_PATH)/build_sf.mk
  xiphos : xiphos_nosimd
endif
