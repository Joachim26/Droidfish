...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
  MY_ARCH_DEF := -D$(ENGINE) -DNNUE -DNNUE_SPARSE -DNNUE_EMBEDDED -O3 -mthumb -march=armv7-a -mfloat-abi=softfp -O3
  include $(CLEAR_VARS)
...
ifeq ($(TARGET_ARCH_ABI),x86)
  MY_ARCH_DEF := -D$(ENGINE) -DNNUE -DNNUE_SPARSE -DNNUE_EMBEDDED -O3
  include $(CLEAR_VARS)
  LOCAL_MODULE    := cfish_nosimd
  include $(LOCAL_PATH)/build_sf.mk
  cfish : cfish_nosimd
