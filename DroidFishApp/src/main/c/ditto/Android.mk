...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
  MY_ARCH_DEF += -DNNUE  -DUSE_NEON -mthumb -march=armv7-a -mfloat-abi=softfp -mfpu=neon
  LOCAL_ARM_NEON := true
endif
ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
  MY_ARCH_DEF += -march=armv8-a+simd -DNNUE  -DIS_64BIT -DUSE_POPCNT -DUSE_NEON -mfpu=neon -mpopcnt -m64
endif
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
  MY_ARCH_DEF := -D$(ENGINE) -DNNUE -O3 -mthumb -march=armv7-a -mfloat-abi=softfp -O3
  include $(CLEAR_VARS)
  LOCAL_ARM_NEON  := false
  LOCAL_MODULE    := ditto_nosimd
  include $(LOCAL_PATH)/build_sf.mk
  ditto : ditto_nosimd
endif

ifeq ($(TARGET_ARCH_ABI),x86)
  MY_ARCH_DEF := -D$(ENGINE) -DNNUE   -O3
  include $(CLEAR_VARS)
  LOCAL_MODULE    := ditto_nosimd
  include $(LOCAL_PATH)/build_sf.mk
  ditto : ditto_nosimd
