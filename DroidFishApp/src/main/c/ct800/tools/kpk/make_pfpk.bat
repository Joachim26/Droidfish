...
set "compiler_options=-Wall -Wextra -Wlogical-op -Wstrict-prototypes -Wshadow -Werror -O2 -s -std=c99 -fno-strict-aliasing -fno-strict-overflow -fno-common -fno-set-stack-executable -mconsole -static -pie -fPIE -Wl,-e,_mainCRTStartup -Wl,--dynamicbase -Wl,--nxcompat -Wl,-s"
