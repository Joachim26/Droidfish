...
FLASH_ROM static const uint32_t Crc32Table[256] = {
...
FLASH_ROM static const uint8_t crc8_table[256] = {
...
/*one additional hour position, for tens of hours. in mate search mode,
