...
namespace {
  ...
  Option Options[] = {
    ...
    { "Mobility (Middle Game)", "150", "100", SPIN, 0, 200, {""} },
    ...
    { "Passed Pawns (Middle Game)", "150", "150", SPIN, 0, 200, {""} },
    { "Passed Pawns (Endgame)", "150", "150", SPIN, 0, 200, {""} },
    { "Space", "200", "200", SPIN, 0, 200, {""} },
    { "Aggressiveness", "200", "200", SPIN, 0, 200, {""} },
    { "Cowardice", "0", "0", SPIN, 0, 200, {""} },
    ...
    { "Discovered Check Bonus", "5", "5", SPIN, 0, 8, {""} },
    { "Mate Threat Bonus", "8", "8", SPIN, 0, 8, {""} },
    ...
    { "Mate Threat Extension (PV nodes)", "2", "2", SPIN, 0, 2, {""} },
    { "Mate Threat Extension (non-PV nodes)", "1", "1", SPIN, 0, 2, {""} },
    { "Pawn Push to 7th Extension (PV nodes)", "1", "1", SPIN, 0, 2, {""} },
    { "Pawn Push to 7th Extension (non-PV nodes)", "0", "0", SPIN, 0, 2, {""} },
    ...
    { "Pawn Endgame Extension (non-PV nodes)", "1", "1", SPIN, 0, 2, {""} },
