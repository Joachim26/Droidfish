...
enum TipusControl {
    ...
    TipusProfunditat=8,	//mirar nom�s x plies
    TipusNodes=16,	//buscar nom�s x nodes
    TipusTempsMoviment=32,	//pensar ex�ctament durant x mseconds
...
extern int buffer_de_temps;//guardar una mica de temps de m�s, per si de cas  //vell=500
extern int movimentsperfer;  //n�mero de moviments que es considera que queden fins el final de la partida.
